...
- Building my own AI infrastructure stack around <abbr title="messenger of the gods">Hermes Agent</abbr> — a personal agent, an llm wiki and knowledge-base, and a thought capture system I'm actively building · <!-- HERMES_START -->💤 dreaming...<!-- HERMES_END -->
...
---
<!-- INCIDENT_START -->*⏱️ days since last production incident: **7***<!-- INCIDENT_END -->

<!-- You are in a maze of twisty little passages, all alike. -->

<!-- b25lIG9mZiByb3VuZGluZyBidWcKdGVuIHRob3VzYW5kIGludm9pY2VzIHdyb25nCnBhZ2UgZmlyZXMgYXQgbWlkbmlnaHQ= -->
